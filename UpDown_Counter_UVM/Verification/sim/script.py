...
if(wave == '0' or wave == "command_line"):
   out = "vlog ../env/cntr_pkg.sv ../rtl/dut_top.sv ../top/cntr_top.sv +incdir+../env +incdir+../test +incdir+../top +incdir+../rtl  && vsim -c -sv_seed random -l test.log {1} -do \"run -all;exit\" +UVM_TESTNAME={0} +UVM_VERBOSITY={2}".format(test,"top", verbosity)

#for displaying waveform
elif(wave == '1' or wave == "with_waveform"):
   out = "vlog ../env/cntr_pkg.sv ../rtl/dut_top.sv ../top/cntr_top.sv +incdir+../env +incdir+../test +incdir+../top +incdir+../rtl  && vsim -sv_seed random -l test.log {1} -do \"do wave.do; run -all\" +UVM_TESTNAME={0} +UVM_VERBOSITY={2}".format(test,"top", verbosity)
